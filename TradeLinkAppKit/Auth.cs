    ...
    public sealed class Auth 
    {
        ...
        public bool isAuthorized(string key, bool appendrandom, bool throwexception, bool showerrorbox, bool pause)
        {
            ...
            try
            {
                ...
                string res = Util.geturl(rurl, debug);
        ...
        static TradeLink.API.DebugDelegate debs = null;
        static void debugs(string msg)
        {
            if (debs != null)
                debs(msg);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetNetworkAddress() { return GetNetworkAddress(null); }
