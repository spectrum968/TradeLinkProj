...
namespace TradeLink.Common
{
    ...
    /// </summary>
    [Serializable]
    public class TradeImpl : Trade, TradeLink.API.SymbolI
    {
        long _id = 0;
        ...
        {
            const char d = ',';
            return t.xdate.ToString(System.Globalization.CultureInfo.InvariantCulture) + d + 
                t.xtime.ToString(System.Globalization.CultureInfo.InvariantCulture) + d + 
                d + 
                t.symbol + d + 
                t.side.ToString() + d + 
                t.xsize.ToString(System.Globalization.CultureInfo.InvariantCulture) + d + 
                t.xprice.ToString(System.Globalization.CultureInfo.InvariantCulture) + d + 
                d + 
                t.Account + d + 
                t.Security.ToString() + d + 
                t.Currency.ToString() + d + 
                t.LocalSymbol + d + 
                t.id.ToString(System.Globalization.CultureInfo.InvariantCulture) + d + 
                t.ex; 
        }
        /// <summary>
