...
namespace TradeLink.Common
{
    ...
    public class TickTracker : GenericTrackerI, GotTickIndicator
    {
        ...
        /// <param name="idx"></param>
        /// <returns></returns>
        public bool HasBid(string sym) { var idx = getindex(sym); return HasBid(idx); }
        /// <summary>
        /// whether we have a ask
        /// </summary>
        /// <param name="idx"></param>
        /// <returns></returns>
        public bool HasAsk(string sym) { var idx = getindex(sym); return HasAsk(idx);}
        /// <summary>
        /// whether we have a ask
        /// </summary>
        /// <param name="idx"></param>
        ...
        /// <param name="idx"></param>
        /// <returns></returns>
        public bool HasLast(string sym) { var idx = getindex(sym); return HasLast(idx); }
        /// <summary>
    ...
    public class BidTracker : GenericTracker<decimal>, GenericTrackerDecimal, GotTickIndicator
    {
        ...
        public override int addindex(string txt, decimal v) { return getindex(txt); }
    ...
    public class SizeTracker : GenericTracker<int>, GenericTrackerInt, GotTickIndicator
    {
        ...
        public override int addindex(string txt, int v) { return getindex(txt); }
    ...
    public class IsTradeTracker : GenericTracker<bool>, GenericTrackerBool, GotTickIndicator
    {
        ...
        public override int addindex(string txt, bool v) { return getindex(txt); }
