...
namespace TradeLink.Common
{
    ...
    public class IdTracker : GenericTracker<long>, IConvertible
    {
        ...
        public void Reset(string sym, string name)
        {
            var idname = getidname(sym, name);
            Reset(idname);
        }
        ...
        public override void Reset(string idname)
        {
            var idx = getindex(idname);
            Reset(idx);
        ...
        public override void Reset(int idx)
        {
            ...
            // reset the id but leave the name
            base[idx] = 0;
            // reset number of fires
            idnamefires[idx] = 0;
            var idname = id2idname[idx];
            debug("name: " + idname + " reset to: " + 0);
