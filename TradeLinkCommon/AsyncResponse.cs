...
namespace TradeLink.Common
{
    ...
    {
        public const int MAXTICK_COMMON = 30000;
        public const int MAXIMB_COMMON = 100000;
        ...
        /// </summary>
        public AsyncResponse() : this(MAXTICK_COMMON, MAXIMB_COMMON) { }
        /// <summary>
        ...
        public void Stop()
        {
            ...
            try
            {
                _tickcache = new RingBuffer<Tick>(MAXTICK_COMMON);
                _imbcache = new RingBuffer<Imbalance>(MAXIMB_COMMON);
                _imbswaiting.Reset();
                _tickswaiting.Reset();
            }
            catch { }
