...
{
    public delegate void DoubleDel(double p);
    ...
    public delegate System.Collections.Generic.List<string> GetAvailableGenericViewNamesDel();
    ...
    public delegate Position[] PositionArrayDelegate();
    public delegate Position[] PositionAccountArrayDelegate(string account);
