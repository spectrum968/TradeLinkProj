...
namespace WinGauntlet
{
		...
		/// eg:
		/// public class MyStrategy : RBResponse
		/// {
		/// }
		/// </summary>
		public class RBResponse : Response
		{
			/// <summary>
			...
			/// </summary>
			/// <param name="o"></param>
			public virtual void sendorder(Order o) { o.VirtualOwner = ID; if (SendOrderEvent != null) SendOrderEvent(o, ID); }
			/// <summary>
			...
			/// </summary>
			/// <param name="indicators"></param>
			public virtual void sendindicators(object[] indicators) { string[] s = new string[indicators.Length]; for (int i = 0; i < indicators.Length; i++) s[i] = indicators[i].ToString(); if (SendIndicatorsEvent != null)SendIndicatorsEvent(ID, string.Join(",", s)); }
			/// <summary>
